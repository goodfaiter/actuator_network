...
df = read_mcap_to_dataframe("/workspace/src/actuator_network/plots/data/ramp_rosbag2_2026_02_27-14_16_41_0_processed_0.mcap", topics=["/desired_position_rad_data", "/measured_position_rad_data", "/load_newton_data"])
